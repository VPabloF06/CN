...
# -*- coding: utf-8 -*-
"""
Created on Tue Sep 23 13:13:26 2025
...
errors0, i0 = newton_iter(-1, niter)
errors1, i1 = (newton_iter(2, niter))
gmailñerrors2, i2 = (newton_iter(3, niter))
errors3, i3 = (newton_iter(2.5, niter))
